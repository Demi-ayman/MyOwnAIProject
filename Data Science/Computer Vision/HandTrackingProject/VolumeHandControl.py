...
while True:
    ...
    if len(lmlist) !=0 :
        ...
        if length < 50:
            ...
            cv2.circle(img,(cx,cy),14,(0,0,255),cv2.FILLED)
        #print(length)
    cv2.rectangle(img ,(50,150),(85,400),(255,0,0),3)
    cv2.rectangle(img ,(50,int(volBar)),(85,400),(255,0,0),cv2.FILLED)
    cv2.putText(img, f'{int(volPer)}%',(40,440), cv2.FONT_HERSHEY_PLAIN ,1.8 , (255,0,0),3)

    cTime = time.time()
    fbs= 1/(cTime-pTime)
    pTime = cTime
    cv2.putText(img, f'FPS: {(int(fbs))}',(10,70), cv2.FONT_HERSHEY_COMPLEX ,1 , (255,50,0),3)
